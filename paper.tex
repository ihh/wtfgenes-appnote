...
on simulated datasets. For values of $N$ from 1 to 4, we sampled $N$ terms from the yeast subset of the Gene Ontology
were randomly sampled, and generated a corresponding gene set with false positive rate 0.1\% and false negative rate 1\%.
