...
The probability parameters are $\pi$ (term activation), $\alpha$ (false positive observation) and $\beta$ (false negative observation),
...
and allows for future model variations where, for example, each gene has its own false positive parameter $\beta_i$.
