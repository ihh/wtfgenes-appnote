...
ggplot(aes(x = fpr, y = recall, color = Method, shape = Terms, group = interaction(Method,Terms)), data = data) + geom_point() + xlab("1 - Specificity") + ylab("Recall") + theme(legend.position = c(.88,.25))
